package com.br.softstream.order_service.config.kafka;
...
public class KafkaConfig {
	...
	@Bean
	ProducerFactory<String, String> producerFatory() {
	...
	@Bean
	NewTopic startSagaTopic() {
		return buildTopic(startSagaTopic);
	}
	
	@Bean NewTopic notifyEndingTopic() {
